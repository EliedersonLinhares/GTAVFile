...
public class x64b {
	public x64b(JButton btnx64b, JLabel lblx64bsize, JLabel lblx64bmd5, JLabel ico1x64b,JLabel ico2x64b,ImageIcon IconNO, ImageIcon IconOK) {
		...
		btnx64b.addActionListener(new ActionListener() {
				...
				fileChooser.addChoosableFileFilter(new FileFilter() {
					...
					public boolean accept(File f) {
						if (f.isDirectory()) {
							...
							return f.getName().toLowerCase().endsWith("x64b.rpf");
						}
					}
				});
